				...
				if(packets[x].toString()[0] != '#') {
					...
					try {
						...
						if(rpt.messageType == '>') {
                            ...
                            console.log(instance.callsign.toUpperCase());
                            console.log(rpt.addressee.toUpperCase());
                            console.log(rpt.number);
...
function Send(message, inst) {
    ...
    try {
        ...
        console.log(instance.isTransmitEnabled);
        console.log(message instanceof APRSMessage);
